    ...
    return (
        <Layout>
          <Routes>
            ...
            <Route path={'/Identity'} element={<ApiAuthorizationRoutes />} />
            ...
            <Route path='/profile' element={<Profile currentUser={currentUser}/>} />
              ...
              <Route path='/profile/materials' element={<Profile currentUser={currentUser} active={'materials'}/>} />
              <Route path='/profile/events' element={<Profile currentUser={currentUser} active={'events'}/>} />
