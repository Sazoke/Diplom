            ...
            <div className='row'>
                <div className='col'>
                    {content[0] && <BlockContent contentName={content[0].name}
                                                       ...
                                                       contentTypeOrDate={content[0].typeId ?? content[0].dateTime}
                ...
                <div className='col'>
                    {content[1] && <BlockContent contentName={content[1].name}
                                                       ...
                                                       contentTypeOrDate={content[1].typeId ?? content[0].dateTime}
            ...
            <div className='row'>
                <div className='col'>
                    {content[2] && <BlockContent contentName={content[2].name}
                                                       ...
                                                       contentTypeOrDate={content[2].typeId ?? content[0].dateTime}
                ...
                <div className='col'>
                    {content[3] ? <BlockContent contentName={content[3].name}
                                                ...
                                                contentTypeOrDate={content[3].typeId ?? content[0].dateTime}
